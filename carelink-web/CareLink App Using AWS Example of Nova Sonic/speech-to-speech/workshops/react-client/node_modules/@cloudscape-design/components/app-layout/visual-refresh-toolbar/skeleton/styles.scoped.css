...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_7nfqu_1sgnw_153:not(#\9) {
...
@media (min-width: 689px) {
  .awsui_root_7nfqu_1sgnw_153:not(#\9) {
    ...
    grid-template-columns: min-content minmax(var(--space-layout-content-horizontal-buc0zz, 24px), 1fr) minmax(0, var(--awsui-max-content-width-g964ok)) minmax(var(--space-layout-content-horizontal-buc0zz, 24px), 1fr) min-content min-content;
    grid-template-rows: min-content min-content 1fr min-content;
  }
  .awsui_root_7nfqu_1sgnw_153.awsui_has-adaptive-widths-default_7nfqu_1sgnw_197:not(#\9) {
    --awsui-max-content-width-g964ok: 1620px;
  }
}
@media (min-width: 689px) and (min-width: 1401px) {
  .awsui_root_7nfqu_1sgnw_153.awsui_has-adaptive-widths-dashboard_7nfqu_1sgnw_202:not(#\9) {
...
.awsui_navigation_7nfqu_1sgnw_217:not(#\9),
.awsui_tools_7nfqu_1sgnw_218:not(#\9),
.awsui_global-tools_7nfqu_1sgnw_219:not(#\9) {
  grid-row: 1/-1;
  grid-column: 1/-1;
...
@media (min-width: 689px) {
  ...
  .awsui_tools_7nfqu_1sgnw_218:not(#\9):not(:has(> [data-testid])) {
    inline-size: var(--awsui-tools-width-g964ok);
  }
  .awsui_tools_7nfqu_1sgnw_218:not(#\9):not(:has(> [data-testid])).awsui_tools-open_7nfqu_1sgnw_257 {
...
@media (min-width: 689px) {
  .awsui_split-panel-side_7nfqu_1sgnw_270:not(#\9) {
...
.awsui_split-panel-bottom_7nfqu_1sgnw_277:not(#\9) {
  position: sticky;
  z-index: 840;
  align-self: end;
  grid-area: main;
...
.awsui_panel-hidden_7nfqu_1sgnw_290:not(#\9) {
  border-block: none;
  border-inline: none;
  opacity: 0;
  z-index: 0;
}
.awsui_panel-hidden_7nfqu_1sgnw_290.awsui_navigation_7nfqu_1sgnw_217:not(#\9), .awsui_panel-hidden_7nfqu_1sgnw_290.awsui_tools_7nfqu_1sgnw_218:not(#\9), .awsui_panel-hidden_7nfqu_1sgnw_290.awsui_global-tools_7nfqu_1sgnw_219:not(#\9) {
  inline-size: 0px;
}

.awsui_toolbar-container_7nfqu_1sgnw_300:not(#\9) {
  grid-area: toolbar;
  block-size: 42px;
  border-block-end: var(--border-divider-section-width-uwo8my, 1px) solid var(--color-border-layout-px1i24, #c6c6cd);
}

.awsui_notifications-container_7nfqu_1sgnw_306:not(#\9) {
  grid-area: notifications;
}

.awsui_notifications-background_7nfqu_1sgnw_310:not(#\9) {
...
.awsui_main-landmark_7nfqu_1sgnw_321:not(#\9) {
  display: contents;
}

.awsui_main_7nfqu_1sgnw_321:not(#\9) {
  grid-area: main;
  margin-block-start: var(--space-scaled-s-8ozaad, 12px);
  margin-block-end: var(--space-layout-content-bottom-zeb1g9, 40px);
}
.awsui_main-disable-paddings_7nfqu_1sgnw_330:not(#\9) {
  margin-block: 0;
  grid-column: 1/-1;
}
@media (min-width: 689px) {
...
.awsui_content-header_7nfqu_1sgnw_340:not(#\9) {
  margin-block-end: var(--space-content-header-padding-bottom-rvy5xz, 16px);
}

.awsui_content_7nfqu_1sgnw_340:not(#\9) {
  display: contents;
}

/* stylelint-disable-next-line selector-combinator-disallowed-list, selector-max-universal */
@media (max-width: 688px) {
  .awsui_unfocusable-mobile_7nfqu_1sgnw_350 *:not(#\9) {
    visibility: hidden;
  }
}